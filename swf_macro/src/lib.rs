...
use quote::quote;
use syn::{
    parse_macro_input, parse_quote, Data, DeriveInput, Fields, FnArg, ImplItem, ImplItemFn,
    ItemEnum, ItemTrait, Meta, Pat, TraitItem, Visibility,
};
...
/// Usage:
/// ```
/// use swf_macro::enum_trait_object;
///
/// #[enum_trait_object(
